...
<Accordions type="single">
  ...
  <Accordion id="programmatic-scroll" title="How do I scroll programmatically?">
    Access the context ref and call `scrollToBottom()` method directly in
  ...
  <Accordion id="preserve-position" title="How to preserve position on new messages?">
    This React component auto-preserves when user has scrolled up. Only
    auto-scrolls when at bottom in Next.js applications.
  </Accordion>

  {" "}

  <Accordion id="virtualization" title="When should I add virtualization?">
    After 200-300 messages in JavaScript applications. Use react-window or
